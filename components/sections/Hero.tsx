    ...
    <div className="z-10 w-full max-w-xl py-11 flex flex-col justify-center items-center">
      ...
      <div className="mx-auto mt-6 flex items-center justify-center space-x-5 ">
        ...
        <Button
          asChild
          variant="outline"
          className=" gap-2 text-sm text-black hover:text-white bg-white hover:bg-black  rounded-full shadow-xl hover:border-white/50"
        >
          <Link
          ...
          >
            ...
            <p>
              <span className="hidden sm:inline-block">Checkout on</span> GitHub
            </p>
          </Link>
        </Button>
      </div>
